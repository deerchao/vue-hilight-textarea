(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hilighttextarea"] = factory(require("vue"));
	else
		root["hilighttextarea"] = factory(root["Vue"]);
...
// load the styles
var content = __webpack_require__("e895");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("3c2397f2", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HilightTextArea_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c165");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HilightTextArea_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HilightTextArea_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HilightTextArea_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony default export */ var RangeTree = ({
  ...
  cloneNode: function cloneNode(node) {
    var dest = _createNode();

    _cloneNode(node, dest);
  ...
  addRanges: function addRanges(node, values, sorted) {
    _addRanges(node, values, sorted || false);
  },
  addRange: function addRange(node, value) {
    _addRange(node, value);
  },
  compareRanges: function compareRanges(a, b) {
    return _compareRanges(a, b);
  },
  createRange: function createRange(value) {
    return _createRange(value);
  }
});
...
function _createRange(value) {
  if ('length' in value && 'end' in value) return _objectSpread({}, value);
...
function findParentNode(node, value) {
  ...
  if (!node.value || node.value.start <= value.start && node.value.end >= value.end) return node;
  return null;
}

function _addRanges(node, values, sorted) {
  if (!sorted) values.sort(_compareRanges);

  for (var i = 0; i < values.length; i++) {
    _addRange(node, values[i]);
  }
}

function _addRange(node, value) {
  var parent = findParentNode(node, value);
  if (!parent) return;

  for (var i = 0; i < parent.children.length; i++) {
    var sibling = parent.children[i];
    if (!sibling.value) continue; // sibling is before current node

    if (sibling.value.end <= value.start) continue;

    if (sibling.value.start >= value.end) {
      // sibling is after current node
      parent.children.splice(i, 0, _createNode(value));
      ...
      var firstPart = _createRange({
        start: value.start,
        end: sibling.value.start,
        tag: value.tag
      });

      var secondPart = _createRange({
        start: sibling.value.start,
        length: sibling.value.length,
        tag: value.tag
      });

      var thirdPart = _createRange({
        start: sibling.value.end,
        end: value.end,
        tag: value.tag
      });

      if (firstPart.length > 0) _addRange(parent, firstPart);

      _addRange(sibling, secondPart);

      if (thirdPart.length > 0) _addRange(parent, thirdPart);
    } else if (sibling.value.start <= value.start && sibling.value.end >= value.end) {
      ...
      var _firstPart = _createRange({
        start: value.start,
        end: sibling.value.end,
        tag: value.tag
      });

      var _secondPart = _createRange({
        start: sibling.value.end,
        end: value.end,
        tag: value.tag
      });

      if (_firstPart.length > 0) _addRange(sibling, _firstPart);
      if (_secondPart.length > 0) _addRange(parent, _secondPart);
    } else if (sibling.value.end >= value.end) {
      // sibling's head overlaps with current node
      var _firstPart2 = _createRange({
        start: value.start,
        end: sibling.value.start,
        tag: value.tag
      });

      var _secondPart2 = _createRange({
        start: sibling.value.start,
        end: value.end,
        tag: value.tag
      });

      if (_firstPart2.length > 0) _addRange(parent, _firstPart2);
      if (_secondPart2.length > 0) _addRange(sibling, _secondPart2);
    } else {
...
function _cloneNode(source, dest) {
  dest.value = source.value ? _createRange(source.value) : null;
  dest.children = [];

  for (var i = 0; i < source.children.length; i++) {
    var target = _createNode();

    _cloneNode(source.children[i], target);

    dest.children.push(target);
  }
}

function _compareRanges(a, b) {
  if (a.start < b.start) return -1;
  if (a.start > b.start) return 1; // longer segments first
...
//# sourceMappingURL=hilighttextarea.umd.js.map